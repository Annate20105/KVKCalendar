...
public protocol CalendarDataSource: AnyObject {
    ...
    /// Use this method to add a custom day cell
    func dequeueCell<T: UIScrollView>(event: Event, type: CalendarType, view: T, indexPath: IndexPath) -> KVKCalendarCellProtocol?
    ...
    /// Use this method to add a footer view
    func dequeueFooter<T: UIScrollView>(type: CalendarType, view: T, indexPath: IndexPath) -> KVKCalendarHeaderProtocol?
}
...
public extension CalendarDataSource {
    ...
    /// Use this method to add a custom day cell
    func dequeueCell<T: UIScrollView>(event: Event, type: CalendarType, view: T, indexPath: IndexPath) -> KVKCalendarCellProtocol?  { return nil }
    ...
    /// Use this method to add a footer view
    func dequeueFooter<T: UIScrollView>(type: CalendarType, view: T, indexPath: IndexPath) -> KVKCalendarHeaderProtocol? {return nil}
}
